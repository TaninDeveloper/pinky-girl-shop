                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-4 col-md-3">
                    ...
                    <div className="d-flex align-items-center justify-content-center bg-light rounded-pill p-1">
                      ...
                      <button className="btn btn-sm text-success fw-bold"
            ...
            <div className="card p-4 shadow-sm border-0"
             style={{ borderRadius: '25px', backgroundColor: '#fdf0f6' }}>
              ...
              {!showCheckout ? (
                ...
                style={{ background: 'linear-gradient(90deg, #fcd1e2ff, #ec0e93)', borderRadius: '15px', border: 'none' }}>
                  تکمیل نهایی خرید
                </button>
              ) : (
